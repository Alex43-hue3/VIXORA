...
(function(){
  ...
  async function list(kind,page=1){
    ...
    const promise=(async()=>{
      ...
      // V18: combinamos los dos proveedores. No usamos Promise.any porque
      // eso podía ocultar títulos que existían únicamente en el otro catálogo.
      const merged=[];
      const seen=new Set();
      const keyFor=item=>{
